...
./configure --prefix=${HWLOC_DIR} ${bgq} ${handle_pci} --disable-cairo --disable-libxml2 --disable-cuda --disable-opencl --with-x=no --disable-gl --enable-shared=no --enable-static=yes
